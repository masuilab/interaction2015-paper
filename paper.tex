...
\begin{figure}[H]
\begin{center}
\includegraphics[width=70mm,bb=0 0 241 306]{figures/image.png}
\end{center}
\caption{降臨鉄道}
\label{screenshot2}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=70mm,bb=0 0 241 306]{figures/korin.png}
\end{center}
...
Double RoboticsのDouble\footnotetext{
...
動画の配信にはAndroidアプリケーションIP Webcam\footnotetext{
...
Webサーバ上に実装したlinda-server\footnotetext{
